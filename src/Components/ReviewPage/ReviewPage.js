      ...
      <div className="reviews-container">
        <div className="reviews-left">
          <div className="review">
            ...
            <div className="review-text">
              <p><strong>Tshepo</strong> · December 2024</p>
          ...
          <div className="review">
            ...
            <div className="review-text">
              <p><strong>Lerato</strong> · December 2024</p>
          ...
          <div className="review">
            ...
            <div className="review-text">
              <p><strong>Nkululeko</strong> · November 2024</p>
        ...
        <div className="reviews-right">
          <div className="review">
            ...
            <div className="review-text">
              <p><strong>Charity</strong> · December 2024</p>
          ...
          <div className="review">
            ...
            <div className="review-text">
              <p><strong>Thabo</strong> · November 2024</p>
          ...
          <div className="review">
            ...
            <div className="review-text">
              <p><strong>Siyabonga</strong> · January 2024</p>
